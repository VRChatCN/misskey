...
import { MiVrchatBinding } from '@/models/VrchatBinding.js';
import { MiVrchatConfig } from '@/models/VrchatConfig.js';
...
export type VrchatBindingsRepository = Repository<MiVrchatBinding> & MiRepository<MiVrchatBinding>;
export type VrchatConfigRepository = Repository<MiVrchatConfig> & MiRepository<MiVrchatConfig>;
