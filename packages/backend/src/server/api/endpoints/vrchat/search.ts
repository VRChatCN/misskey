...
export const meta = {
	...
	errors: {
		notEnabled: { message: 'VRChat integration is not enabled.', code: 'VRCHAT_NOT_ENABLED', id: 'f0a0b1c1-0001-4000-a000-000000000001' },
	},
} as const;
...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(private vrchatService: VrchatService) {
		super(meta, paramDef, async (ps) => {
			...
			return await this.vrchatService.searchUsers(ps.query);
		});
	}
}
